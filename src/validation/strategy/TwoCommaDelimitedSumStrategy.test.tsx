...
import { TwoCommaDelimitedSumStrategy } from './TwoCommaDelimitedSumStrategy';

var strategy = new TwoCommaDelimitedSumStrategy();

beforeEach(() => {
    strategy = new TwoCommaDelimitedSumStrategy();
})
...
test('Entering three numbers should return invalid length', () => {
    const providedValue = "13, 10, 2";
    const expectedResult = {
        validatorResponse: ValidatorResponse.INVALID_LENGTH,
        result: null,
        errorMessage: null
    };
